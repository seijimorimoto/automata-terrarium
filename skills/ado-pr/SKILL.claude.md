...
hooks:
  PostToolUse:
    - matcher: Bash
      hooks:
        - type: command
          command: powershell.exe -NoProfile -NonInteractive -ExecutionPolicy RemoteSigned -Command "$input | & \"$env:CLAUDE_PROJECT_DIR\.claude\skills\ado-pr\scripts\capture-pr.ps1\""
---
