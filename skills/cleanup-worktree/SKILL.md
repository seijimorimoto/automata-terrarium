...
- User-provided argument (optional): A branch name or worktree path to target. If omitted, the skill auto-detects the current worktree or lists all worktrees for selection.
...
- Always use **single quotes** around shell string arguments (per project AGENTS.md).
